...
<!-------------------------- -
  ...
  --------------------------
    OPull-downn list control w each Personalysis responder
-------------------------- -->  
...
bsselect(plots, type = "img", size='8',frame_height='70', height='70', style= "btn-primary", #style= "btn-primary",
...
## Tom F  - vs -  Jessica S  {.tabset}

### Expedite <span style="color:darkred;">(Red)</span> 
```{r echo = FALSE, results ='asis'}
the_color= 'r'; the_team = 'TomF_vs_JessicaS'
```
```{r, echo = FALSE, results ='asis', code = readLines("R/Personalysis_3D_function.R")}
``` 
...
### Explore <span style="color:blue;">(Blue)</span> 
```{r echo = FALSE, results ='asis'}
the_color= 'b'; the_team = 'TomF_vs_JessicaS'
```
```{r, echo = FALSE, results ='asis', code = readLines("R/Personalysis_3D_function.R")}
```  
...
### Organize <span style="color:green;">(Green)</span> 
```{r echo = FALSE, results ='asis'}
the_color= 'g'; the_team = 'TomF_vs_JessicaS'
```
```{r, echo = FALSE, results ='asis', code = readLines("R/Personalysis_3D_function.R")}
```    
...
### Collaborate <span style="color:goldenrod;">(Yellow)</span> 
```{r echo = FALSE, results ='asis'}
the_color= 'y'; the_team = 'TomF_vs_JessicaS'
```
```{r, echo = FALSE, results ='asis', code = readLines("R/Personalysis_3D_function.R")}
``` 
