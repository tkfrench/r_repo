...
collapsibleTree(test %>% arrange(r_cluster, Name_red), c("r_cluster","Name_red"), collapsed = F, root="COMBINED ",fontSize=14, zoomable = FALSE, fill= reds2, nodeSize = "r_mean")
``` 
</div>
...
collapsibleTree(test %>% arrange(r1_cluster, Name), c("r1_cluster","Name_red1"), collapsed = F, root="Contribution ",fontSize=14, zoomable = FALSE, fill= reds2, nodeSize = "r1")
```  
</div>
...
collapsibleTree(test %>% arrange(r3_cluster, Name), c("r3_cluster","Name_red3"), collapsed = F, root="Commitment ",fontSize=14, zoomable = FALSE, fill= reds2, nodeSize = "r1")
```   
</div>
...
```{r  echo=FALSE}
Personalysis %>% select(Name, n, Desc) %>% pivot_wider(names_from = n, values_from= Desc)
```
